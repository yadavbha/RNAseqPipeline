#!/bin/bash
#SBATCH -A project_2001209
#SBATCH --partition=large
#SBATCH -t 24:00:00
#SBATCH -J RNASeqPipelineBY
...
echo 'Input three files in order along with their full path 1) bam file of a sample, 2) bed12 file for reference and 3) gtf file for reference'
bam=$1

################### Reference genome locations
bed12= $2 
#"/sw/data/uppnex/igenomes/Homo_sapiens/Ensembl/GRCh37/Annotation/Genes/genes.bed"
gtf=$3
#"/sw/data/uppnex/igenomes/Homo_sapiens/Ensembl/GRCh37/Annotation/Genes/genes.gtf"
